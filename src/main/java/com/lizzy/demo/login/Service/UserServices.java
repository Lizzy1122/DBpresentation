...
import com.lizzy.demo.login.mapper.UserMappers;
...
//        System.out.println("server"+user.getUsername()+user.getPassword()+user.getUserType());
        User dbUser = userMapper.selectByUsername(user.getUsername(),user.getUserType());
        if(dbUser == null){
    ...
    public User register(User user) {
        System.out.println(userMapper.selectByUsername(user.getUsername(),user.getUserType()));
        ...
        if(userMapper.selectByUsername(user.getUsername(),user.getUserType())==null){
            userMapper.insert(dbuser.getUsername(),dbuser.getUserType(),dbuser.getPassword(),dbuser.getUserID());
